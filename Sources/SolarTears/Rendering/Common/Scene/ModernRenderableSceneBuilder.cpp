...
void ModernRenderableSceneBuilder::BakeSceneFirstPart()
{
	...
	intermediateBufferSize = CreateBufferPrerequisiteObjects(intermediateBufferSize);

	//Load texture images
	intermediateBufferSize = CreateTexturePrerequisiteObjects(sceneTexturesVec, intermediateBufferSize);
...
size_t ModernRenderableSceneBuilder::CreateBufferPrerequisiteObjects(size_t currentIntermediateBufferSize)
{
	...
	CreateVertexBufferPrerequisiteObject(vertexDataSize);
	...
	CreateIndexBufferPrerequisiteObject(indexDataSize);
	...
	CreateConstantBufferPrerequisiteObject(constantPerObjectDataSize + constantPerFrameDataSize);
...
size_t ModernRenderableSceneBuilder::CreateTexturePrerequisiteObjects(const std::vector<std::wstring>& sceneTextures, size_t intermediateBufferSize)
{
	mIntermediateBufferTextureDataOffset = Utils::AlignMemory(intermediateBufferSize, D3D12_TEXTURE_DATA_PLACEMENT_ALIGNMENT);
