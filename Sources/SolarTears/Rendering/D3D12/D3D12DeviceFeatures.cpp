...
#define DECLARE_FEATURE(FEATURE_TYPE) template<> static constexpr D3D12_FEATURE FeatureForType<D3D12_FEATURE_DATA_ ## FEATURE_TYPE> = D3D12_FEATURE_ ## FEATURE_TYPE;
