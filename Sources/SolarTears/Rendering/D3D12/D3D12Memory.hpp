...
namespace D3D12
{
	...
	public:
		...
		void AllocateTextureMemory(ID3D12Device8* device, const std::vector<D3D12_RESOURCE_DESC1>& textureDescs, std::vector<UINT64>& outHeapOffsets, ID3D12Heap** outHeap)                                     const;
